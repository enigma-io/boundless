...
var UIDialog = function (_React$PureComponent) {
    ...
    createClass(UIDialog, [{
        ...
        value: function isPartOfDialog(node) {
            ...
            var element = node.nodeType !== 1 ? node.parentNode : node;
...
var UIModal = function (_React$PureComponent) {
    ...
    function UIModal() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = UIModal.__proto__ || Object.getPrototypeOf(UIModal)).call.apply(_ref, [this].concat(args))), _this), _this.portalUUID = uuid(), _temp), possibleConstructorReturn(_this, _ret);
    }
    ...
    createClass(UIModal, [{
        ...
        value: function renderModal() {
            ...
            this.updateInternalModalCache(ReactDOM__default.render(React__default.createElement(
                ...
                _extends({}, omitKeysFromSourceObject(props, UIModal.internalKeys), {
                    ...
                    id: this.props.id || this.portalUUID }),
        ...
        key: 'render',
        value: function render() {
            return React__default.createElement('div', { 'data-portal': this.props.id || this.portalUUID });
        }
    }]);
    return UIModal;
}(React__default.PureComponent);

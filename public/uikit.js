...
var Table = function () {
    ...
    _createClass(Table, [{
        ...
        value: function resetActiveRowIndex() {
            ...
            this.next_active_row = null;
            this.rows.forEach(function (row) {
                return row.active = row.setIndex === _this7.active_row;
            });

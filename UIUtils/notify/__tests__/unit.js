...
describe('UIUtils/notify', () => {
    ...
    it('should resolve for asked + permission granted', done => {
    ...
    it('should reject for asked + permission denied', done => {
        sandbox.stub(window.Notification, 'permission', 'default');
    ...
    it('should reject for existing permission denied', done => {
    ...
    describe('with existing granted permissions', () => {
        ...
        it('should successfully create a notification', done => {
            notifier(baseConfig).then(done);
        });

        it('should reject for a missing config', done => {
        ...
        it('should reject for a malformed config', done => {
            notifier('').catch(error => {
        ...
        it('should reject for a missing config.body', done => {
        ...
        it('should reject for a malformed config.body', done => {
        ...
        it('should reject for a missing config.header', done => {
        ...
        it('should reject for a malformed config.header', done => {
        ...
        it('should not reject for a missing config.icon', done => {
            notifier(baseConfig).then(done);
        });

        it('should reject for a malformed config.icon', done => {
        ...
        it('should not reject for a missing config.onClick', done => {
            notifier(baseConfig).then(done);
        });

        it('should reject for a malformed config.onClick', done => {

...
export const BODY = 'b-table-body';
export const CELL = 'b-table-cell';
export const CELL_EVEN = 'b-table-cell-even';
export const CELL_ODD = 'b-table-cell-odd';
export const CELL_INNER = 'b-table-cell-inner';
export const HEADER = 'b-table-header';
export const HEADER_CELL = 'b-table-header-cell';
export const HEADER_CELL_HANDLE = 'b-table-header-cell-resize-handle';
export const ROW = 'b-table-row';
export const ROW_EVEN = 'b-table-row-even';
export const ROW_ODD = 'b-table-row-odd';
export const ROW_ACTIVE = 'b-table-row-active';
export const ROW_LOADING = 'b-table-row-loading';
export const OFFSCREEN = 'b-offscreen';
export const WRAPPER = 'b-table-wrapper';
export const X_SCROLL_TRACK = 'b-table-x-scroll-track';
export const X_SCROLL_TRACK_HANDLE = 'b-table-x-scroll-handle';
export const Y_SCROLL_TRACK = 'b-table-y-scroll-track';
export const Y_SCROLL_TRACK_HANDLE = 'b-table-y-scroll-handle';
